...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleBadCredentials(BadCredentialsException ex) {
        ...
        body.put("mensagem", "E-mail ou senha incorretos");
    ...
    public ResponseEntity<Map<String, Object>> handleEntityNotFound(JpaObjectRetrievalFailureException ex) {
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.NOT_FOUND.value());
        body.put("erro", "Recurso referenciado não encontrado");
        body.put("mensagem", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleIOException(java.io.IOException ex) {
        // Erros de upload/leitura de arquivo (Supabase Storage, etc.)
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.INTERNAL_SERVER_ERROR.value());
        body.put("erro", "Erro ao processar arquivo");
        body.put("mensagem", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleResponseStatusException(
        ...
        // Validações que disparam ResponseStatusException (ex.: tipo de arquivo inválido,
        // tamanho excedido na validação interna, etc.)
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", ex.getStatusCode().value());
        body.put("erro", ex.getStatusCode().toString());
        body.put("mensagem", ex.getReason() != null ? ex.getReason() : ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleMaxUploadSize(
        ...
        body.put("erro", "Arquivo muito grande");
        body.put("mensagem", "O arquivo excede o tamanho maximo permitido (10MB).");
