-- =============================================================================
-- SEED — PostgreSQL / Supabase
-- Execute UMA VEZ no SQL Editor do Supabase após o primeiro deploy.
-- As tabelas são criadas automaticamente pelo Spring Boot (ddl-auto=update).
-- =============================================================================
...
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'Coletivo', 1, 'aula experimental', 'Clínica', 55.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000002', 'Coletivo', 1, 'aula avulsa', 'Clínica', 60.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Mensalidade 1x, 2x, 3x/semana
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000003', 'Coletivo', 1, 'frequência/semana', 'Clínica', 225.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- Individual
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'Individual', 2, 'frequência/semana', 'Clínica', 604.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO servicos (id, atividade_id, plano_id, tipo_atendimento, quantidade, unidade_servico, modalidade_local, valor, ativo, created_at, updated_at) VALUES
-- Experimental e Avulso
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000001', 'Coletivo', 1, 'aula experimental', 'Clínica', 55.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000002', 'Coletivo', 1, 'aula avulsa', 'Clínica', 60.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Mensalidade 1x, 2x, 3x/semana
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000003', 'Coletivo', 1, 'frequência/semana', 'Clínica', 225.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- Individual
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000001', 'Individual', 2, 'frequência/semana', 'Clínica', 604.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO servicos (id, atividade_id, plano_id, tipo_atendimento, quantidade, unidade_servico, modalidade_local, valor, ativo, created_at, updated_at) VALUES
-- Clínica
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000006', 'Individual', 1, 'avaliação', 'Clínica', 330.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000007', 'Individual', 1, 'sessão', 'Clínica', 264.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000008', 'Individual', 5, 'sessão', 'Clínica', 1100.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO servicos (id, atividade_id, plano_id, tipo_atendimento, quantidade, unidade_servico, modalidade_local, valor, ativo, created_at, updated_at) VALUES
-- Clínica
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000006', 'Individual', 1, 'avaliação', 'Clínica', 198.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000007', 'Individual', 1, 'sessão', 'Clínica', 154.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000008', 'Individual', 5, 'sessão', 'Clínica', 660.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000008', 'Individual', 10, 'sessão', 'Clínica', 1100.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Domiciliar
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000007', 'Individual', 1, 'sessão', 'Domiciliar', 220.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000008', 'Individual', 5, 'sessão', 'Domiciliar', 880.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000008', 'Individual', 10, 'sessão', 'Domiciliar', 1540.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- =============================================================================
INSERT INTO servicos (id, atividade_id, plano_id, tipo_atendimento, quantidade, unidade_servico, modalidade_local, valor, ativo, created_at, updated_at) VALUES
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000006', 'Individual', 1, 'avaliação', 'Clínica', 330.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000007', 'Individual', 1, 'sessão', 'Clínica', 264.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000008', 'Individual', 5, 'sessão', 'Clínica', 1100.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000008', 'Individual', 10, 'sessão', 'Clínica', 1980.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- =============================================================================
INSERT INTO servicos (id, atividade_id, plano_id, tipo_atendimento, quantidade, unidade_servico, modalidade_local, valor, ativo, created_at, updated_at) VALUES
(gen_random_uuid(), 'a1000000-0000-0000-0000-000000000008', 'b1000000-0000-0000-0000-000000000009', 'Individual', 10, 'sessão', 'Clínica', 4000.00, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
